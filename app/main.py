...
def registry(request: Request, q: str = "", faculty: str = ""):
    s = db()
    contracts, faculties, counts = get_registry(s, q, faculty)
...
def create_org(name: str = Form(...), full_name: str = Form(""), address: str = Form(""), department: str = Form(""), contact: str = Form("")):
    s = db(); org = create_organization(s, name=name, full_name=full_name, address=address, department=department, contact=contact)
