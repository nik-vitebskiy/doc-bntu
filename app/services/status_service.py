...
STATUS_APPLICATION_COMPLETED = "Закрыта заявка"
STATUS_CLOSED = "Закрыт"

CONTRACT_STATUSES = (STATUS_ACTIVE, STATUS_CLOSED)
APPLICATION_STATUSES = (STATUS_APPLICATION, STATUS_APPLICATION_COMPLETED, STATUS_CLOSED)

STATUS_CLASSES = {
    STATUS_ACTIVE: "status-active",
    STATUS_APPLICATION: "status-active",
    STATUS_APPLICATION_COMPLETED: "status-completed",
